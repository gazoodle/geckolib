...
class TestStructAccessor(unittest.TestCase):
    ...
    def setUp(self) -> None:
        """Set up the class."""
        self.struct = GeckoAsyncStructure(self._on_set_value, self._async_on_set_value)
    ...
    def _on_set_value(self, pos: int, len_: int, newvalue: Any) -> None:
        self.last_pos = pos
        self.last_len = len_
    ...
    async def _async_on_set_value(self, pos: int, len_: int, newvalue: Any) -> None:
        self._on_set_value(pos, len_, newvalue)
    ...
    def test_write_byte_from_string(self) -> None:
    ...
    def test_write_word_as_string(self) -> None:
    ...
    @unittest.expectedFailure
    def test_write_enum_not_member(self) -> None:
        """Can we write an enum to the structure."""
        accessor = GeckoEnumStructAccessor(
            self.struct,
            "PackType",
    ...
    def test_write_bool_as_string(self) -> None:
    ...
    def test_write_bitpos_enum(self) -> None:
        """Can we write an enum to the structure."""
        accessor = GeckoEnumStructAccessor(
    ...
    def test_write_sized_bitpos_enum(self) -> None:
    ...
    def test_multiple_write_bitpos_enum(self) -> None:
