#!/usr/bin/python3
"""
    GeckoConfigStruct - A class to manage the ConfigStruct for 'InYJ v62'
"""
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            YMOUNB: GeckoWordStructAccessor(self.struct, YMOUNB, MOUNBL, QBMJVH),
