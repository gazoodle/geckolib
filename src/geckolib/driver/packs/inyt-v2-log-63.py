#!/usr/bin/python3
"""
    GeckoLogStruct - A class to manage the LogStruct for 'InYT-V2 v63'
"""
...
RAHEOC = 2
RAZMKQ = 347
RHYUAX = "".join(chr(c) for c in [76, 73])
RJHIUS = 303
...
class GeckoLogStruct:
    ...
    def accessors(self):
        return {
            ...
            SIFJBI: GeckoWordStructAccessor(self.struct, SIFJBI, IFJBIA, None),
