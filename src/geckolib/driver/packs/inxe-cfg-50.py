...
LXWAJV = [CPQIPO, OUSPBW, QPLSPF, LSPFTS]
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            QPLSPF: GeckoWordStructAccessor(self.struct, QPLSPF, PLSPFT, QBMJVH),
            LSPFTS: GeckoWordStructAccessor(self.struct, LSPFTS, SPFTSI, QBMJVH),
