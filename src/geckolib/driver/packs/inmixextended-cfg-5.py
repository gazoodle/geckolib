...
class GeckoConfigStruct:
    ...
    def accessors(self) -> dict[str, GeckoStructAccessor]:
        ...
        return {
            ...
            "InMixExtended-StatusLightRemindersColor": GeckoEnumStructAccessor(
                self.struct,
                "ConfigStructure/InMixExtended-StatusLightRemindersColor",
                701,
                4,
                [
                    "SAME_AS_NORMAL",
            ...
            "InMixExtended-RemindersNotBlinkingLED": GeckoBoolStructAccessor(
                self.struct,
                "ConfigStructure/InMixExtended-RemindersNotBlinkingLED",
                701,
                7,
                None,
            ),
            "InMixExtended-StatusLightFading": GeckoBoolStructAccessor(
                self.struct,
                "ConfigStructure/InMixExtended-StatusLightFading",
                702,
                0,
                None,
            ),
