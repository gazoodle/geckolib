#!/usr/bin/python3
"""
    GeckoLogStruct - A class to manage the LogStruct for 'InYT v59'
"""
...
XWEEZF = "".join(chr(c) for c in [76, 73])
XYBQSN = "".join(
    chr(c)
...
class GeckoLogStruct:
    ...
    def accessors(self):
        return {
            ...
            PBWJYK: GeckoWordStructAccessor(self.struct, PBWJYK, BWJYKL, None),
