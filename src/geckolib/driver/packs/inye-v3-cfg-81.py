#!/usr/bin/python3
"""
    GeckoConfigStruct - A class to manage the ConfigStruct for 'inYE-V3 v81'
"""
...
AOESVZ = "".join(chr(c) for c in [65, 115, 115, 105, 103, 110, 86, 83, 80, 51])
AONPYY = "".join(chr(c) for c in [79, 117, 116, 49, 50])
APUMEA = "".join(chr(c) for c in [80, 51])
...
BGJFJN = "".join(chr(c) for c in [78, 79, 95, 80, 85, 77, 80])
BHZVOA = 157
...
BSKSOK = 40
BVHDVR = "".join(chr(c) for c in [90, 111, 110, 101, 50, 84, 121, 112, 101])
BVNAXA = "".join(chr(c) for c in [78, 79, 95, 69, 88, 69, 82, 67, 73, 83, 69])
BVWVUB = "".join(
    chr(c)
    for c in [
        77,
...
CYRAPU = "".join(chr(c) for c in [65, 115, 115, 105, 103, 110, 86, 83, 80, 49])
...
DVRIDK = "".join(chr(c) for c in [90, 111, 110, 101, 51, 84, 121, 112, 101])
DXLUBG = "".join(
    chr(c)
    for c in [
        85,
...
ESVZSS = "".join(chr(c) for c in [65, 115, 115, 105, 103, 110, 86, 83, 80, 52])
...
FJNTTU = "".join(chr(c) for c in [80, 51, 95, 84, 79, 95, 80, 53])
FJTACC = 43
FLSIJU = 136
FOUURI = "".join(chr(c) for c in [82, 71, 66])
FSROGM = 110
...
GGVYKL = "".join(chr(c) for c in [51])
GJFJNT = "".join(chr(c) for c in [65, 76, 76, 95, 80, 85, 77, 80, 83])
GKEAKS = "".join(
...
HWOGXX = "".join(chr(c) for c in [90, 79, 78, 69, 52])
...
IBXYBQ = 63
ICXQIE = 13
IDKEYG = "".join(chr(c) for c in [90, 111, 110, 101, 52, 84, 121, 112, 101])
IDNIBX = "".join(
...
JEUTOP = 85
JFJNTT = "".join(chr(c) for c in [80, 50, 95, 84, 79, 95, 80, 53])
...
JNTTUV = "".join(chr(c) for c in [80, 52, 95, 65, 78, 68, 95, 80, 53])
JPUNRJ = 4
...
KLTQLV = "".join(chr(c) for c in [80, 85, 82, 80, 76, 69])
KMLOIJ = 99
...
KXSJWM = 80
KZHWOG = "".join(chr(c) for c in [90, 79, 78, 69, 50])
...
LTQLVH = "".join(chr(c) for c in [79, 82, 65, 78, 71, 69])
LUBGJF = "".join(
    chr(c)
    for c in [
        69,
...
MEAOES = "".join(chr(c) for c in [65, 115, 115, 105, 103, 110, 86, 83, 80, 50])
MECYXM = 81
MFZDGK = 72
MHXEKV = 164
MIKGNV = "".join(
...
MJVHFT = 12
MKQTDK = 64
MKZHWO = "".join(chr(c) for c in [90, 79, 78, 69, 49])
...
NTTUVR = "".join(chr(c) for c in [80, 53, 95, 79, 78, 76, 89])
NVFOUU = "".join(chr(c) for c in [90, 111, 110, 101, 49, 76, 101, 100])
...
PUMEAO = "".join(chr(c) for c in [80, 52])
...
RAHEOC = 36
RAPUME = "".join(chr(c) for c in [80, 50])
...
RIDKEY = 126
RIEVBV = "".join(chr(c) for c in [83, 84, 65, 84, 85, 83])
...
URIEVB = "".join(chr(c) for c in [78, 79, 82, 77, 65, 76])
USOOQN = "".join(chr(c) for c in [57, 65])
USPBWJ = 118
UTOPHU = 86
UTYEKC = 19
UURIEV = "".join(chr(c) for c in [90, 111, 110, 101, 49, 84, 121, 112, 101])
UVMKZH = "".join(
    chr(c)
    for c in [
        73,
...
VFCPOU = 145
VFOUUR = 123
VHDVRI = "".join(chr(c) for c in [90, 111, 110, 101, 51, 76, 101, 100])
...
VMKZHW = 172
VNAXAD = "".join(chr(c) for c in [83, 87, 73, 77, 95, 69, 88, 69, 82, 67, 73, 83, 69])
VOACMC = "".join(chr(c) for c in [83, 76, 69, 69, 80])
VRFLSI = 178
VRIDKE = "".join(chr(c) for c in [90, 111, 110, 101, 52, 76, 101, 100])
VSIBEX = "".join(
...
VZSSBV = "".join(chr(c) for c in [65, 115, 115, 105, 103, 110, 86, 83, 80, 53])
WAJVDQ = 35
WAONPY = 22
WBSIRY = 59
WDAFIK = 108
...
WJYKLG = 32
WMNZMJ = 55
WOGXXY = "".join(chr(c) for c in [65, 83, 95, 49, 50, 86, 95, 83, 85, 80, 80, 76, 89])
WONFZC = "".join(
    chr(c)
...
ZHWOGX = "".join(chr(c) for c in [90, 79, 78, 69, 51])
...
NAXADX = [BVNAXA, VNAXAD]
NQLNMH = [QSNQLN, SNQLNM]
OGXXYO = [MKZHWO, KZHWOG, ZHWOGX, HWOGXX, WOGXXY]
OUURIE = [FOUURI, JLOINE]
...
TQLVHS = [FUBJLO, JLOINE, MXFUBJ, KLTQLV, XFUBJL, BJLOIN, LTQLVH, HZVOAC]
TTUVRF = [BGJFJN, GJFJNT, JFJNTT, FJNTTU, JNTTUV, NTTUVR, VLASSA, VLASSA]
UMEAOE = [JVHFTH, FYLJUI, RAPUME, APUMEA, PUMEAO, YYPIPI]
VXOIHB = [
    JVHFTH,
    VLASSA,
    VLASSA,
...
VYKLTQ = [VLASSA, EYGGVY, YGGVYK, GGVYKL, GVYKLT]
...
YOJQSG = [XYOJQS, JLOINE, MXFUBJ, KLTQLV, XFUBJL, BJLOIN, LTQLVH, HZVOAC]
YYLIUX = [
    JVHFTH,
    VLASSA,
    VLASSA,
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            BXYBQS: GeckoWordStructAccessor(self.struct, BXYBQS, XYBQSN, QBMJVH),
            ...
            AJVDQL: GeckoWordStructAccessor(self.struct, AJVDQL, JVDQLA, QBMJVH),
            VDQLAI: GeckoWordStructAccessor(self.struct, VDQLAI, DQLAII, QBMJVH),
            ...
            CYRAPU: GeckoEnumStructAccessor(
                self.struct, CYRAPU, YRAPUM, None, UMEAOE, None, None, QBMJVH
            ),
            MEAOES: GeckoEnumStructAccessor(
                self.struct, MEAOES, EAOESV, None, UMEAOE, None, None, QBMJVH
            ),
            AOESVZ: GeckoEnumStructAccessor(
                self.struct, AOESVZ, OESVZS, None, UMEAOE, None, None, QBMJVH
            ),
            ESVZSS: GeckoEnumStructAccessor(
                self.struct, ESVZSS, SVZSSB, None, UMEAOE, None, None, QBMJVH
            ),
            VZSSBV: GeckoEnumStructAccessor(
                self.struct, VZSSBV, ZSSBVN, None, UMEAOE, None, None, QBMJVH
            ),
            SSBVNA: GeckoEnumStructAccessor(
                self.struct, SSBVNA, SBVNAX, None, NAXADX, None, None, QBMJVH
            ),
            AXADXL: GeckoEnumStructAccessor(
                self.struct, AXADXL, XADXLU, None, XLUBGJ, None, None, QBMJVH
            ),
            LUBGJF: GeckoEnumStructAccessor(
                self.struct, LUBGJF, UBGJFJ, YOUSPB, TTUVRF, None, OINELW, QBMJVH
            ),
            TUVRFL: GeckoBoolStructAccessor(
                self.struct, TUVRFL, UBGJFJ, BDFSRO, QBMJVH
            ),
            UVRFLS: GeckoEnumStructAccessor(
                self.struct, UVRFLS, VRFLSI, None, UMEAOE, None, None, QBMJVH
            ),
            RFLSIJ: GeckoByteStructAccessor(self.struct, RFLSIJ, FLSIJU, QBMJVH),
            ...
            NVFOUU: GeckoEnumStructAccessor(
                self.struct, NVFOUU, VFOUUR, YOUSPB, OUURIE, None, JYMOUN, None
            ),
            UURIEV: GeckoEnumStructAccessor(
                self.struct, UURIEV, VFOUUR, MAOAWB, IEVBVH, None, JYMOUN, None
            ),
            EVBVHD: GeckoEnumStructAccessor(
                self.struct, EVBVHD, VBVHDV, YOUSPB, OUURIE, None, JYMOUN, None
            ),
            BVHDVR: GeckoEnumStructAccessor(
                self.struct, BVHDVR, VBVHDV, MAOAWB, IEVBVH, None, JYMOUN, None
            ),
            VHDVRI: GeckoEnumStructAccessor(
                self.struct, VHDVRI, HDVRID, YOUSPB, OUURIE, None, JYMOUN, None
            ),
            DVRIDK: GeckoEnumStructAccessor(
                self.struct, DVRIDK, HDVRID, MAOAWB, IEVBVH, None, JYMOUN, None
            ),
            VRIDKE: GeckoEnumStructAccessor(
                self.struct, VRIDKE, RIDKEY, YOUSPB, OUURIE, None, JYMOUN, None
            ),
            IDKEYG: GeckoEnumStructAccessor(
                self.struct, IDKEYG, RIDKEY, MAOAWB, IEVBVH, None, JYMOUN, None
            ),
            DKEYGG: GeckoEnumStructAccessor(
                self.struct, DKEYGG, KEYGGV, YOUSPB, VYKLTQ, None, OINELW, None
            ),
            YKLTQL: GeckoEnumStructAccessor(
                self.struct, YKLTQL, KEYGGV, LXWAJV, TQLVHS, None, OINELW, QBMJVH
            ),
            QLVHSV: GeckoBoolStructAccessor(self.struct, QLVHSV, KEYGGV, BDFSRO, None),
            LVHSVS: GeckoBoolStructAccessor(self.struct, LVHSVS, VFOUUR, MOUNBL, None),
            VHSVSI: GeckoBoolStructAccessor(self.struct, VHSVSI, VFOUUR, EAKSTS, None),
            HSVSIB: GeckoBoolStructAccessor(self.struct, HSVSIB, VFOUUR, EKBDFS, None),
            SVSIBE: GeckoBoolStructAccessor(self.struct, SVSIBE, VFOUUR, BDFSRO, None),
            VSIBEX: GeckoBoolStructAccessor(self.struct, VSIBEX, VBVHDV, MOUNBL, None),
            SIBEXL: GeckoBoolStructAccessor(self.struct, SIBEXL, VBVHDV, EAKSTS, None),
            IBEXLT: GeckoBoolStructAccessor(self.struct, IBEXLT, VBVHDV, EKBDFS, None),
            BEXLTP: GeckoBoolStructAccessor(self.struct, BEXLTP, VBVHDV, BDFSRO, None),
            EXLTPO: GeckoBoolStructAccessor(self.struct, EXLTPO, HDVRID, MOUNBL, None),
            XLTPOX: GeckoBoolStructAccessor(self.struct, XLTPOX, HDVRID, EAKSTS, None),
            LTPOXI: GeckoBoolStructAccessor(self.struct, LTPOXI, HDVRID, EKBDFS, None),
            TPOXIU: GeckoBoolStructAccessor(self.struct, TPOXIU, HDVRID, BDFSRO, None),
            POXIUV: GeckoBoolStructAccessor(self.struct, POXIUV, RIDKEY, MOUNBL, None),
            OXIUVM: GeckoBoolStructAccessor(self.struct, OXIUVM, RIDKEY, EAKSTS, None),
            XIUVMK: GeckoBoolStructAccessor(self.struct, XIUVMK, RIDKEY, EKBDFS, None),
            IUVMKZ: GeckoBoolStructAccessor(self.struct, IUVMKZ, RIDKEY, BDFSRO, None),
            UVMKZH: GeckoEnumStructAccessor(
                self.struct, UVMKZH, VMKZHW, None, OGXXYO, None, None, None
            ),
            GXXYOJ: GeckoEnumStructAccessor(
                self.struct, GXXYOJ, XXYOJQ, MOUNBL, YOJQSG, None, OINELW, QBMJVH
            ),
            OJQSGM: GeckoBoolStructAccessor(self.struct, OJQSGM, XXYOJQ, BDFSRO, None),
        }
