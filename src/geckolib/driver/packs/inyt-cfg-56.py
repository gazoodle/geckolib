#!/usr/bin/python3
"""
    GeckoConfigStruct - A class to manage the ConfigStruct for 'InYT v56'
"""
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            YXBQFY: GeckoWordStructAccessor(self.struct, YXBQFY, XBQFYL, QBMJVH),
