#!/usr/bin/python3
"""
    GeckoLogStruct - A class to manage the LogStruct for 'inYE-V3 v81'
"""
...
FCPOUB = "".join(chr(c) for c in [76, 73])
FCRTFM = 404
FEFJTA = 398
...
class GeckoLogStruct:
    ...
    def accessors(self):
        return {
            ...
            FYLJUI: GeckoWordStructAccessor(self.struct, FYLJUI, YLJUIK, None),
