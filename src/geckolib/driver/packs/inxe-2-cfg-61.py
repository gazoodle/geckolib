"""GeckoConfigStruct - A class to manage the ConfigStruct for 'InXE-2 v61'."""  # noqa: N999
    ...
    def accessors(self) -> dict[str, GeckoStructAccessor]:
        ...
        return {
            ...
            "OutHtRCur": GeckoByteStructAccessor(
                self.struct, "ConfigStructure/HCOutputConfig/OutHtRCur", 42, "ALL"
            ),
            ...
            "DirectCur": GeckoByteStructAccessor(
                self.struct, "ConfigStructure/LCOutputConfig/DirectCur", 41, "ALL"
            ),
            ...
            "DirectFuse": GeckoEnumStructAccessor(
                self.struct,
                "ConfigStructure/InputSupply/DirectFuse",
                88,
                None,
                ["F1", "F2", "F3", "", "", "", "Line1", "Line2"],
                None,
