"""GeckoConfigStruct - A class to manage the ConfigStruct for 'InMix v5'."""  # noqa: N999
...
class GeckoConfigStruct:
    ...
    def accessors(self) -> dict[str, GeckoStructAccessor]:
        ...
        return {
            ...
            "InMix-StatusLightFading": GeckoBoolStructAccessor(
                self.struct, "ConfigStructure/InMix-StatusLightFading", 598, 0, None
            ),
        }
