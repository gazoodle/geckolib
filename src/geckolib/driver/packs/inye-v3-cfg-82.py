...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            SNQLNM: GeckoWordStructAccessor(self.struct, SNQLNM, NQLNMH, QBMJVH),
            ...
            LAIIDN: GeckoWordStructAccessor(self.struct, LAIIDN, AIIDNI, QBMJVH),
