...
QXPICX = "".join(chr(c) for c in [76, 73])
SAKQXP = 13
SSAKQX = "".join(
...
AKQXPI = [ZCQBMJ, HECVYY, LASSAK, SSAKQX]
KQXPIC = []
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ZCQBMJ: GeckoWordStructAccessor(self.struct, ZCQBMJ, CQBMJV, QBMJVH),
            ...
            HECVYY: GeckoWordStructAccessor(self.struct, HECVYY, ECVYYP, QBMJVH),
