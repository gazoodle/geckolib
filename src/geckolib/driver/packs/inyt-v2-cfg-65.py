#!/usr/bin/python3
"""
    GeckoConfigStruct - A class to manage the ConfigStruct for 'InYT-V2 v65'
"""
...
class GeckoConfigStruct:
    ...
    def accessors(self):
        return {
            ...
            SIJUZM: GeckoBoolStructAccessor(self.struct, SIJUZM, TUVRFL, ACMCVD, None),
            IJUZMR: GeckoBoolStructAccessor(self.struct, IJUZMR, BVNAXA, YMOUNB, None),
            JUZMRK: GeckoBoolStructAccessor(self.struct, JUZMRK, BVNAXA, IKJPUN, None),
            UZMRKV: GeckoBoolStructAccessor(self.struct, UZMRKV, BVNAXA, VOACMC, None),
            ZMRKVF: GeckoBoolStructAccessor(self.struct, ZMRKVF, BVNAXA, ACMCVD, None),
            MRKVFC: GeckoBoolStructAccessor(self.struct, MRKVFC, LUBGJF, YMOUNB, None),
            RKVFCP: GeckoBoolStructAccessor(self.struct, RKVFCP, LUBGJF, IKJPUN, None),
            KVFCPO: GeckoBoolStructAccessor(self.struct, KVFCPO, LUBGJF, VOACMC, None),
            VFCPOU: GeckoBoolStructAccessor(self.struct, VFCPOU, LUBGJF, ACMCVD, None),
            FCPOUB: GeckoBoolStructAccessor(self.struct, FCPOUB, GJFJNT, YMOUNB, None),
            CPOUBM: GeckoBoolStructAccessor(self.struct, CPOUBM, GJFJNT, IKJPUN, None),
            POUBMI: GeckoBoolStructAccessor(self.struct, POUBMI, GJFJNT, VOACMC, None),
            OUBMIK: GeckoBoolStructAccessor(self.struct, OUBMIK, GJFJNT, ACMCVD, None),
            UBMIKG: GeckoBoolStructAccessor(self.struct, UBMIKG, JNTTUV, YMOUNB, None),
            BMIKGN: GeckoBoolStructAccessor(self.struct, BMIKGN, JNTTUV, IKJPUN, None),
            MIKGNV: GeckoBoolStructAccessor(self.struct, MIKGNV, JNTTUV, VOACMC, None),
            IKGNVF: GeckoBoolStructAccessor(self.struct, IKGNVF, JNTTUV, ACMCVD, None),
        }
